...
_FXGATEWAY = _descriptor.ServiceDescriptor(
  name='FxGateway',
  full_name='pb.FxGateway',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='GetMeta',
    full_name='pb.FxGateway.GetMeta',
    index=5,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='ReplicaUpdate',
    full_name='pb.FxGateway.ReplicaUpdate',
    index=7,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='HealthCheck',
    full_name='pb.FxGateway.HealthCheck',
    index=9,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_MESSAGE,
...
_sym_db.RegisterServiceDescriptor(_FXGATEWAY)

DESCRIPTOR.services_by_name['FxGateway'] = _FXGATEWAY
